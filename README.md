...
<li>Mobile (min-width; 428px); <br>
  <img width="30%" src="img/mobile.gif" alt="alura-books-mobile"><br>
<li>Tablet (min-widtth: 1024px); <br>
  <img width=350%" src="img/tablet.gif" alt="alura-books-tablet"><br>
<li>Desktop (min-width: 1728px). <br>
<img width="30%" src="img/desktop.gif" alt="alura-books-desktop"><br><br>
